...
//=========================================================
#define ADD_IN0_ADDR 0x0020
#define ADD_IN1_ADDR 0x0022
#define ADD_OUT_ADDR 0x0024
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    for (uint64_t i=0; i < NUM_TESTS; i++) {
      ...
      afu.write(ADD_IN0_ADDR, in0);
      afu.write(ADD_IN1_ADDR, in1);
      uint64_t sum  = afu.read(ADD_OUT_ADDR);
