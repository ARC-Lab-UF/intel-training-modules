...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS         "$QSYS_SIMDIR/../altera_fp_functions_171/sim/mult_float_altera_fp_functions_171_z2kbsra.vhd" -work altera_fp_functions_171 -cdslib ./cds_libs/altera_fp_functions_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mult_float.v"                                                                  -work mult_float                                                                
fi
