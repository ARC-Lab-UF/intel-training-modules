...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "mult_float.mult_float"
}
...
ensure_lib                         ./libraries/mult_float             
vmap       mult_float              ./libraries/mult_float             
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../altera_fp_functions_171/sim/mult_float_altera_fp_functions_171_z2kbsra.vhd" -work altera_fp_functions_171
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mult_float.v"                                                                  -work mult_float             
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L altera_fp_functions_171 -L mult_float -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
