...
# ACDS 17.1.2 304 linux 2020.05.29.14:41:21
# ----------------------------------------
...
# ----------------------------------------
# If add_float.add_float is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "add_float.add_float"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/tools/Intel/quartus/17.1.2.304/quartus/"
}
...
ensure_lib                         ./libraries/altera_fp_functions_171
vmap       altera_fp_functions_171 ./libraries/altera_fp_functions_171
ensure_lib                         ./libraries/add_float              
vmap       add_float               ./libraries/add_float              
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../altera_fp_functions_171/sim/dspba_library_package.vhd"                     -work altera_fp_functions_171
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../altera_fp_functions_171/sim/dspba_library.vhd"                             -work altera_fp_functions_171
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/../altera_fp_functions_171/sim/add_float_altera_fp_functions_171_rgz4tay.vhd" -work altera_fp_functions_171
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/add_float.v"                                                                  -work add_float              
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L altera_fp_functions_171 -L add_float -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
