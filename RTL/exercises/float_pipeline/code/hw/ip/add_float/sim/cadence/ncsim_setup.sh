...
TOP_LEVEL_NAME="add_float.add_float"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS         "$QSYS_SIMDIR/../altera_fp_functions_171/sim/dspba_library_package.vhd"                     -work altera_fp_functions_171 -cdslib ./cds_libs/altera_fp_functions_171.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS         "$QSYS_SIMDIR/../altera_fp_functions_171/sim/dspba_library.vhd"                             -work altera_fp_functions_171 -cdslib ./cds_libs/altera_fp_functions_171.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS         "$QSYS_SIMDIR/../altera_fp_functions_171/sim/add_float_altera_fp_functions_171_rgz4tay.vhd" -work altera_fp_functions_171 -cdslib ./cds_libs/altera_fp_functions_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/add_float.v"                                                                  -work add_float                                                                 
fi
